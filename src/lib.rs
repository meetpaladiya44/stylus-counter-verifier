...
//!         number = newNumber;
//!     }
//!     function increment_verifier() public {
//!         number++;
//!     }
//! }
//! ```
...
impl Counter {
    ...
    /// increment_verifier_verifiers `number` and updates its value in storage.
    pub fn increment_verifier(&mut self) {
